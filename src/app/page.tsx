...
type Tab = "rec" | "hist" | "gph" | "ai" | "set";

const TABS: { id: Tab; label: string; path: string }[] = [
  { id: "rec",  label: "きろく",  path: "M4 20h16M6 16l9-9 3 3-9 9H6v-3Z" },
  { id: "hist", label: "食事",    path: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" },
  ...
  return (
    <div className="app-root">
      ...
      <div className="app-content">
        ...
        {tab === "hist" && <MealHistoryPage store={store} showToast={showToast} />}
            ...
            return (
              ...
              >
                <div style={{
                  ...
                  <svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke={active ? "#fff" : "#B7C6D8"} strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round">
                    <path d={t.path} />
                  </svg>
                </div>
                <span style={{ fontSize: 9, fontWeight: 800, color: active ? "#3D9BFF" : "#B7C6D8" }}>{t.label}</span>
              </button>
            );
          })}
        </div>
